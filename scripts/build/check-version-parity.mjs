...
import { readReleaseVersion, validateReleaseVersion, assertVersionParity } from './lib/versioning.mjs';
...
try {
  ...
  const pluginJson = JSON.parse(
    readFileSync(join(ROOT, 'plugins', 'core-skills', '.claude-plugin', 'plugin.json'), 'utf8')
  );
  assertVersionParity(version, pluginJson.version, 'plugins/core-skills/.claude-plugin/plugin.json');
