...
test('skill outcomes adapter - multiple valid lines return multiple events', () => {
  ...
  try {
    const lines = [
      JSON.stringify({ skill_name: 'skill-a', outcome: 'output_used', timestamp: '2026-03-23T10:00:00Z' }),
      JSON.stringify({ skill_name: 'skill-b', outcome: 'output_replaced', timestamp: '2026-03-23T10:01:00Z' }),
      JSON.stringify({ skill_name: 'skill-a', outcome: 'output_used', timestamp: '2026-03-23T10:02:00Z' }),
    ];
