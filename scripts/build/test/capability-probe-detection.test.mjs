...
function probeWith(extraEnv) {
  const output = execFileSync("bash", [PROBE_SCRIPT, "--quiet"], {
    env: { ...BASE_ENV, HOME: process.env.HOME || "/tmp", ...extraEnv },
    encoding: "utf8",
  });
