...
export const strengthLabels = {
  pasted_diff: {
    ...
    description: 'Can spot patterns in changed lines; cannot verify broader impact',
  },
  github_pr: {
    level: 'degraded',
...
export const templates = {
  onStart: {
    ...
    upgrade_available: 'If you continue in {strongerRouteLabel}, I can {upgradeUnlocks}',
  },
  onResume: {
    headline: 'Continuing your {taskTypeLabel}',
    progress_with_upgrade: '{findingsCount} findings from earlier session, ready for {upgradeDescription}',
  ...
  onUpgradeAvailable: {
    headline: 'With {strongerRouteLabel}, I can verify these {findingsCount} findings against call sites and related tests',
    prompt: 'Continue with deeper inspection?',
  },
  onShelfView: {
    headline_with_upgrade: '{taskTypeLabel} — {findingsCount} findings ready for {upgradeDescription}',
    headline_without_upgrade: '{taskTypeLabel} — {findingsCount} findings collected',
    continuation_with_upgrade: '{strongerRouteLabel} unlocks verification of {pendingCount} earlier findings',
    continuation_without_upgrade: 'Resume to continue collecting findings',
  },
};

export const upgradeUnlocksDescriptions = {
  local_repo: 'verify call sites, check related tests, inspect dependency graph',
