// Worker-safe variant of TaskStore without Ajv schema validation.
...
function createSnapshot(task) {
  // Worker-safe: skip Ajv validation; JSON.parse boundary provides type safety
  return {
...
export class TaskStore {
  ...
  create(task) {
    // Worker-safe: skip Ajv validation; HTTP parsing ensures valid JSON structure
  ...
  update(taskId, { expectedVersion, changes }) {
    ...
    // Worker-safe: skip Ajv validation; changes already parsed and merged safely
