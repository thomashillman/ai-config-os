 ...
 */
export function deriveEffectiveRouteCapabilities(route_profile, route_instance_facts) {
...
function narrowVerificationCeiling(default_ceiling, artifact_surface) {
  ...
  if (artifact_surface === 'repo_tree_partial' || artifact_surface === 'artifact_bundle') {
