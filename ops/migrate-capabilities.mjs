...
const MIGRATION = {
  ...
  'changelog': {
    ...
    platforms: {
      'claude-ios': { mode: 'degraded', notes: 'Prompt-only from pasted history' },
    },
  },
  'code-review': {
    capabilities: {
  ...
  'git-ops': {
    ...
    platforms: {
      'claude-ios': { mode: 'degraded', notes: 'Prompt-only from pasted state' },
    },
  },
  'pr-description': {
    capabilities: {
  ...
  'release-checklist': {
    ...
    platforms: {
      'claude-ios': { mode: 'excluded', notes: 'Requires git and shell access' },
    },
  },
  'skill-audit': {
    capabilities: {
