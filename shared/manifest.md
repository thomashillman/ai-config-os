...
| `agnostic-labs-skill-creator` | Create new skills conforming to the Agent Skills open standard and this repo's extended format | `shared/skills/agnostic-labs-skill-creator/SKILL.md` |
