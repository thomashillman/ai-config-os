...
| `pr-description`     | PR title + canonical markdown body (Summary, Type, pre-merge checklists, Specific Changes, CI status); template at `templates/pr-body-default.md` | `shared/skills/pr-description/SKILL.md`     |
...
| `merge-conflict-resolution` | Resolves git merge/rebase conflicts, verifies merge conclusion, and reviews bulk one-side resolutions against upstream | `shared/skills/merge-conflict-resolution/SKILL.md` |
