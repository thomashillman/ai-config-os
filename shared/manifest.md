...
| `agnostic-labs-skill-creator` | Skill development environment: scaffold, iterate, validate, and ship skills conforming to the Agent Skills open standard | `shared/skills/agnostic-labs-skill-creator/SKILL.md` |
