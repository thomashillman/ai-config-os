...
export const rule = {
  ...
  async execute(event) {
    ...
    const isProtectedPath = file_path && file_path.includes('/plugins/core-skills/skills/');
    if (!isProtectedPath) {
      return { decision: 'allow' };
    }
    ...
    return {
      decision: 'block',
      reason: 'Author skills in shared/skills/ not plugins/ directly. Symlinks handle plugin wiring automatically.'
    };
  }
};
